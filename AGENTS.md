...
- `src/components/ui/**` добавляет CLI shadcn-vue. Oxfmt и Oxlint проверяют
  его наравне с остальным кодом (правило «не форматировать ради минимального
  diff с реестром» отменено 2026-09-22, см. §5.2 спецификации перевода UI).
